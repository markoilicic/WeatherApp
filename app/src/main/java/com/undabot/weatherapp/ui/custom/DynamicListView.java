...
public class DynamicListView extends ListView {
	...
	/**
	 * Set selected item border color, default is BLACK.
	 */
	public void setSelectedItemBorderColor(int borderColorResId) {
		mBorderColor = borderColorResId;
	}
	...
	private void updateNeighborViewsForID(long itemID) {
		...
		EditCityListAdapter adapter = ((EditCityListAdapter) getAdapter());
